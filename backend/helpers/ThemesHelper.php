...
class ThemesHelper {
    ...
    public function ModuleThemePath($module, $currentPath) {
        ...
        if (Yii::$app->settings->getSettings('BackendTheme') != null) {
            return Yii::getAlias('@realAppPath') . '/themes/admin/' . Yii::$app->settings->getSettings('BackendTheme') . "/module/$module/views";
        } else {
    ...
    public function ModuleWidgetsThemePath($module, $currentPath) {
        ...
        if (Yii::$app->settings->getSettings('BackendTheme') != null) {
            return Yii::getAlias('@realAppPath') . '/themes/admin/' . Yii::$app->settings->getSettings('BackendTheme') . "/module/$module/widgets/views";
        } else {
